...
class Game:
    ...
    phase: GamePhaseName = GamePhaseName.LOBBY
    ...
    player_idx: int = 0
    _turn_order: list[player.Nickname] = dataclasses.field(
    ...
    def add_player(self, nickname: player.Nickname) -> None:
    ...
    def start(self, timeout_in: datetime.timedelta) -> None:
        ...
        self.player_idx = 0
        self.phase = GamePhaseName.FIRST_PLACEMENT
