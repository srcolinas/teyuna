...
from ._trade_and_build import LongestRoadResult


class PathfinderPhase(_core.GamePhaseNode[LongestRoadResult | None, None, None]):
    def __init__(self) -> None:
        self._paths_placed = 0

    def run(
        self, game: entities.ActiveGame, request: _core.PlayerRequest
    ) -> _core.RunOutcome[LongestRoadResult | None]:
