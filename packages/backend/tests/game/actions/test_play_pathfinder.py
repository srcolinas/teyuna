...
def test_pathfinder_awards_longest_road_on_fifth_path(
    ...
    game.use_edge(player, teyuna_core.canonical_edge(0, 0, 0))
    game.use_edge(player, teyuna_core.canonical_edge(0, 0, 1))
    game.use_edge(player, teyuna_core.canonical_edge(0, 0, 2))
    fourth, fifth = (
