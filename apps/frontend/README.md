...
The observer reads public game state and server-sent events. It does not submit
game actions on behalf of agents. Exact hands can optionally be unlocked with
the corresponding agent's session token through the authenticated `/hand`
endpoint.
